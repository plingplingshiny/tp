...
public class EditCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        ...
        assertParseFailure(parser, "1 i/ string", Intention.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_PROPERTY_TYPE_DESC, PropertyType.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY
                + VALID_PHONE_AMY + VALID_PROPERTY_TYPE_AMY + VALID_PRICE_AMY, Name.MESSAGE_CONSTRAINTS);
    }
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + NAME_DESC_AMY + PROPERTY_TYPE_DESC_BOB + PRICE_DESC_AMY;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withPropertyType(VALID_PROPERTY_TYPE_BOB).withPrice(VALID_PRICE_AMY)
                .build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // property type
        userInput = targetIndex.getOneBased() + PROPERTY_TYPE_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withPropertyType(VALID_PROPERTY_TYPE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);

        // price
        userInput = targetIndex.getOneBased() + PRICE_DESC_AMY;
        descriptor = new EditPersonDescriptorBuilder().withPrice(VALID_PRICE_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
                ...
                + PHONE_DESC_BOB + ADDRESS_DESC_BOB + EMAIL_DESC_BOB + PROPERTY_TYPE_DESC_AMY
                + PROPERTY_TYPE_DESC_BOB + PRICE_DESC_AMY + PRICE_DESC_BOB;
        ...
        userInput = targetIndex.getOneBased() + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
                + INVALID_PHONE_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC + INVALID_PROPERTY_TYPE_DESC
                + INVALID_PRICE_DESC + INVALID_PROPERTY_TYPE_DESC + INVALID_PRICE_DESC;
